...
for request in requests_l:
    ...
    try:
        ...
        print(f"ERROR! PUT /circulation/loans/{request_to_put['id']} {json.dumps(request_to_put)}")
        print(ee)
        traceback.print_exc()
